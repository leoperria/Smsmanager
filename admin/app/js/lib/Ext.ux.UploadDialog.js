...
p.i18n = {
  ...
  add_btn_tip: 'Aggiungi file alla coda di upload.',
  remove_btn_text: 'Elimina',
  remove_btn_tip: 'Elimina file dala coda di upload.',
  reset_btn_text: 'Reset',
  reset_btn_tip: 'Reset coda.',
  upload_btn_start_text: 'Upload',
  upload_btn_stop_text: 'Annulla',
  upload_btn_start_tip: 'Importa tutti i file nel server.',
  upload_btn_stop_tip: 'Annulla upload.',
  close_btn_text: 'Chiudi',
  close_btn_tip: 'Chiudi la finestra.',
  progress_waiting_text: 'Attendere...',
  progress_uploading_text: 'Importazione: {0} di {1} files completata.',
  error_msgbox_title: 'Errore',
  permitted_extensions_join_str: ',',
  err_file_type_not_permitted: 'L\'Estensione del file selezionato non &egrave; permessa.<br/>Selezionare i file con le seguenti estensioni: {1}',
  note_queued_to_upload: 'In coda per il caricamento.',
  note_processing: 'Caricamento in corso...',
  note_upload_failed: 'Il Server non è disponibile o si è verificato un errore interno del server .',
  note_upload_success: 'OK.',
  note_upload_error: 'Errore di caricamento.',
  note_aborted: 'Interrotto dall\'utente.',
  note_canceled: 'Caricamento annullato'
}