Application.organizations.EntryWorked = function(orgid,id,utente,azienda){
  this.orgid=orgid;
  this.id=id;
  this.utente=utente;
  this.azienda=azienda;    
  this.init({winConfig:{title:'Contatti inseriti da : '+this.utente+' per '+this.azienda,width:650},deleteUrl:'contatti/delete'});
};

Ext.extend(Application.organizations.EntryWorked, Application.apiGrid.WinList, {

  getStoreConfig:function(){

    return new Ext.data.JsonStore({
      url: 'contatti/listbydataentry',
      baseParams:{
        orgid:this.orgid,
        id:this.id
      },
