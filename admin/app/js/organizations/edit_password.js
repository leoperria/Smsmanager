Application.organizations.WinEditPassword = function(){
  ...
  this.init({
    ...
    saveUrl:'usersadmin/setpassword',
    labelWidth:130
  });
  
};

Ext.extend(Application.organizations.WinEditPassword , Application.api.GenericForm, {
