Application.mainApplication = function(){
  ...
  function createUI(){
    ...
    menuStrumentiItems.push({
    	text: 'Archivio campagne',
        icon:'css/icons/folder_page.png',
        iconCls:'x-btn-text-icon',
        handler: function(){
          var win=new Application.campagne.WinList();
          win.show();
        },
        scope: this
       },{
        ...
        iconCls:'x-btn-text-icon',
        handler: function(){
          var win=new Application.contatti.WinContatti();
          win.show();
        },
        scope: this
       },{
        text: 'Importa contatti',
        icon:'css/icons/vcard.png',
        iconCls:'x-btn-text-icon',
        handler: function(){
          var win=new Application.contatti.ImportWin();
          win.show();
        },
        scope: this
       },{
        ...
        iconCls:'x-btn-text-icon',
        handler: function(){
          var win=new Application.gruppi.WinGruppi();
          win.show();
        },
        scope: this
       },{
    ...
    ,'-',{
	  text: 'Ricariche SMS',
      width:80,
	  icon:'css/icons/shield.png',
	  iconCls:'x-btn-text-icon',
	  handler:function(){
    	var w=new Application.ricariche.WinGatewayRicariche();
    	w.show();
	  },
	  scope:this
	},'-');
	  ...
	  viewport = new Ext.Viewport({
        ...
        height:40,
        border:false,
        html:'<div id="infoSMS" class="cassa_information"></div>'
      }]
	  });
