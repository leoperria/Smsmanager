Application.mainApplication = function(){
  ...
  function createUI(){
    ...
    menuStrumentiItems.push({
        ...
        handler: function(){
            var win=new Application.dataentry.WinDataEntry();
            win.show();
        },
        scope: this
      },{
      ...
      text: 'Permessi',
      icon:'css/icons/lock.png',
      iconCls:'x-btn-text-icon',
      handler: function(){
          var win=new Application.permissions.WinPermissions();
          win.show();
      },
      scope: this
    },{
      text: 'Ruoli',
      icon:'css/icons/group_gear.png',
      iconCls:'x-btn-text-icon',
      handler: function(){
         var win=new Application.roles.WinRoles();
         win.show();
      },
      scope: this
    },{
